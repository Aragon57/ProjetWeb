      ...
      <div class="row">
        ...
        <div class="autocomplete">
            ...
            <div class="recherche_p">
                <form id="searchbar" autocomplete="on" action="/search" method="get">
                    <input type="text" id="myInput" placeholder="" name="myCountry">
                    <button onlick ="Recherche" type="submit"><i class="fa fa-search"></i></button>
                </form>
            </div>
        </div>
