...
@endphp
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-8 sm-12 text-center"><img src="/storage{{$image['image']}}" alt="Probleme chargement"

              class="" >
              <div class="row">
               <div class="col-lg-6 col-md-12 sm-18 text-center">    

                <form method="get" action="/likepic/{{ $event->id}}" > 
                  @csrf
                  @php
                  if ($image->liked==true){
...
<hr><h5> Vous avez participé à cet event !! </h5>
